...
(async () => {
  ...
  await page.waitForXPath("//*[@id='salesperson_result']/div[1]/div[1]/div/select/option[2]");
  const [opciones] = await page.$x("//*[@id='salesperson_result']/div[1]/div[1]/div/select/option[2]");
  var opcionesD = await Functions.getTextXelement(page, opciones);
  //await opcionesD.click({clickCount: 1, delay: 100});
  await page.keyboard.press('ArrowDown');
  await page.keyboard.press("Enter");
  console.log(opcionesD);
